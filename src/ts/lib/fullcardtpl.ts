...
<div class="faculty-modal-wrapper">
	<div class="faculty-modal">
		<div class="faculty-modal-header" style="background-image:url(/lpk-2024-restricted/img/faculty_media/wallpapers/{{selectedLevel.details.image}})">
				...
				<div class="faculty">
					...
					<div class="head-info-wrapper">
						<div class="head-image">
							<img src="/lpk-2024-restricted/img/faculty_media/decans/{{extra.head.photo}}">
						</div>
						<div class="head-data">
							<p>{{extra.head.rank}}</p>
